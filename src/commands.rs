...
use structs::*;
        ...
        impl blockdev_snapshot_internal_sync {
            pub fn new()->blockdev_snapshot_internal_sync{
                blockdev_snapshot_internal_sync{
                    execute: "blockdev_snapshot_internal_sync".to_string(),
        ...
        pub struct blockdev_snapshot_delete_internal_sync {
            execute: String,
            pub id:String,pub name:String,pub device:String
        }
            ...
            pub fn new(id:String,name:String,device:String)->blockdev_snapshot_delete_internal_sync{
                blockdev_snapshot_delete_internal_sync{
                    ...
                    id:id,name:name,device:device
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<SnapshotInfo,String>{
                            try!(json::decode(&response))
                        }
        ...
        pub struct eject {
            execute: String,
            pub force:String,pub device:String
        }
        impl eject {
        ...
        impl nbd_server_stop {
            pub fn new()->nbd_server_stop{
                nbd_server_stop{
                    execute: "nbd_server_stop".to_string(),
        ...
        impl query_block_jobs {
            pub fn new()->query_block_jobs{
                query_block_jobs{
                    execute: "query_block_jobs".to_string(),
        ...
        pub struct block_passwd {
            execute: String,
            pub device:String,pub node_name:String,pub password:String
        }
        impl block_passwd {
            pub fn new(device:String,node_name:String,password:String)->block_passwd{
                block_passwd{
                    execute: "block_passwd".to_string(),
                    device:device,node_name:node_name,password:password
                }
            }
        ...
        pub struct block_resize {
            execute: String,
            pub device:String,pub node_name:String,pub size:String
        }
        impl block_resize {
            pub fn new(device:String,node_name:String,size:String)->block_resize{
                block_resize{
                    execute: "block_resize".to_string(),
                    device:device,node_name:node_name,size:size
                }
            }
        ...
        impl blockdev_snapshot_sync {
            pub fn new()->blockdev_snapshot_sync{
                blockdev_snapshot_sync{
                    execute: "blockdev_snapshot_sync".to_string(),
        ...
        pub struct change_backing_file {
            execute: String,
            pub backing_file:String,pub device:String,pub image_node_name:String
        }
        impl change_backing_file {
            pub fn new(backing_file:String,device:String,image_node_name:String)->change_backing_file{
                change_backing_file{
                    execute: "change_backing_file".to_string(),
                    backing_file:backing_file,device:device,image_node_name:image_node_name
                }
            }
        ...
        pub struct block_commit {
            execute: String,
            pub backing_file:String,pub base:String,pub speed:String,pub top:String,pub device:String
        }
        impl block_commit {
            pub fn new(backing_file:String,base:String,speed:String,top:String,device:String)->block_commit{
                block_commit{
                    execute: "block_commit".to_string(),
                    backing_file:backing_file,base:base,speed:speed,top:top,device:device
                }
            }
        ...
        impl drive_backup {
            pub fn new()->drive_backup{
                drive_backup{
                    execute: "drive_backup".to_string(),
        ...
        impl blockdev_backup {
            pub fn new()->blockdev_backup{
                blockdev_backup{
                    execute: "blockdev_backup".to_string(),
        ...
        impl query_named_block_nodes {
            pub fn new()->query_named_block_nodes{
                query_named_block_nodes{
                    execute: "query_named_block_nodes".to_string(),
        ...
        pub struct drive_mirror {
            execute: String,
            pub buf_size:String,pub format:String,pub granularity:String,pub mode:String,pub node_name:String,pub on_source_error:String,pub on_target_error:String,pub replaces:String,pub speed:String,pub device:String,pub sync:String,pub target:String
        }
        impl drive_mirror {
            pub fn new(buf_size:String,format:String,granularity:String,mode:String,node_name:String,on_source_error:String,on_target_error:String,replaces:String,speed:String,device:String,sync:String,target:String)->drive_mirror{
                drive_mirror{
                    execute: "drive_mirror".to_string(),
                    buf_size:buf_size,format:format,granularity:granularity,mode:mode,node_name:node_name,on_source_error:on_source_error,on_target_error:on_target_error,replaces:replaces,speed:speed,device:device,sync:sync,target:target
                }
            }
        ...
        impl block_dirty_bitmap_add {
            pub fn new()->block_dirty_bitmap_add{
                block_dirty_bitmap_add{
                    execute: "block_dirty_bitmap_add".to_string(),
        ...
        impl block_dirty_bitmap_remove {
            pub fn new()->block_dirty_bitmap_remove{
                block_dirty_bitmap_remove{
                    execute: "block_dirty_bitmap_remove".to_string(),
        ...
        impl block_dirty_bitmap_clear {
            pub fn new()->block_dirty_bitmap_clear{
                block_dirty_bitmap_clear{
                    execute: "block_dirty_bitmap_clear".to_string(),
        ...
        pub struct block_set_io_throttle {
            execute: String,
            pub bps_max:String,pub bps_rd_max:String,pub bps_wr_max:String,pub iops_max:String,pub iops_rd_max:String,pub iops_size:String,pub iops_wr_max:String,pub bps:String,pub bps_rd:String,pub bps_wr:String,pub device:String,pub iops:String,pub iops_rd:String,pub iops_wr:String
        }
        impl block_set_io_throttle {
            pub fn new(bps_max:String,bps_rd_max:String,bps_wr_max:String,iops_max:String,iops_rd_max:String,iops_size:String,iops_wr_max:String,bps:String,bps_rd:String,bps_wr:String,device:String,iops:String,iops_rd:String,iops_wr:String)->block_set_io_throttle{
                block_set_io_throttle{
                    execute: "block_set_io_throttle".to_string(),
                    bps_max:bps_max,bps_rd_max:bps_rd_max,bps_wr_max:bps_wr_max,iops_max:iops_max,iops_rd_max:iops_rd_max,iops_size:iops_size,iops_wr_max:iops_wr_max,bps:bps,bps_rd:bps_rd,bps_wr:bps_wr,device:device,iops:iops,iops_rd:iops_rd,iops_wr:iops_wr
                }
            }
        ...
        pub struct block_stream {
            execute: String,
            pub backing_file:String,pub base:String,pub on_error:String,pub speed:String,pub device:String
        }
        impl block_stream {
            pub fn new(backing_file:String,base:String,on_error:String,speed:String,device:String)->block_stream{
                block_stream{
                    execute: "block_stream".to_string(),
                    backing_file:backing_file,base:base,on_error:on_error,speed:speed,device:device
                }
            }
        ...
        pub struct block_job_set_speed {
            execute: String,
            pub device:String,pub speed:String
        }
        ...
        pub struct block_set_write_threshold {
            execute: String,
            pub node_name:String,pub write_threshold:String
        }
        impl block_set_write_threshold {
            pub fn new(node_name:String,write_threshold:String)->block_set_write_threshold{
                block_set_write_threshold{
                    ...
                    node_name:node_name,write_threshold:write_threshold
                }
            }
        ...
        impl query_version {
            pub fn new()->query_version{
                query_version{
                    execute: "query_version".to_string(),
                    
                }
            }
            
                        pub fn parse_qemu_response(response: &String) -> QemuResult<VersionInfo,String>{
                            try!(json::decode(&response))
                        }
        ...
        impl query_commands {
            pub fn new()->query_commands{
                query_commands{
                    execute: "query_commands".to_string(),
        ...
        pub struct trace_event_set_state {
            execute: String,
            pub ignore_unavailable:String,pub enable:String,pub name:String
        }
        impl trace_event_set_state {
            pub fn new(ignore_unavailable:String,enable:String,name:String)->trace_event_set_state{
                trace_event_set_state{
                    ...
                    ignore_unavailable:ignore_unavailable,enable:enable,name:name
                }
            }
            ...
            pub fn new()->query_name{
                query_name{
                    execute: "query_name".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<NameInfo,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_kvm{
                query_kvm{
                    execute: "query_kvm".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<KvmInfo,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_status{
                query_status{
                    execute: "query_status".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<StatusInfo,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_uuid{
                query_uuid{
                    execute: "query_uuid".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<UuidInfo,String>{
                            try!(json::decode(&response))
                        }
        ...
        pub struct ringbuf_read {
            execute: String,
            pub format:String,pub device:String,pub size:String
        }
        impl ringbuf_read {
            pub fn new(format:String,device:String,size:String)->ringbuf_read{
                ringbuf_read{
                    execute: "ringbuf_read".to_string(),
                    format:format,device:device,size:size
                }
            }
            
                        pub fn parse_qemu_response(response: &String) -> QemuResult<str,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_migrate{
                query_migrate{
                    execute: "query_migrate".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<MigrationInfo,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_migrate_parameters{
                query_migrate_parameters{
                    execute: "query_migrate_parameters".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<MigrationParameters,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_vnc{
                query_vnc{
                    execute: "query_vnc".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<VncInfo,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_spice{
                query_spice{
                    execute: "query_spice".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<SpiceInfo,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_balloon{
                query_balloon{
                    execute: "query_balloon".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<BalloonInfo,String>{
                            try!(json::decode(&response))
                        }
        ...
        pub struct human_monitor_command {
            execute: String,
            pub cpu_index:String,pub command_line:String
        }
        impl human_monitor_command {
            pub fn new(cpu_index:String,command_line:String)->human_monitor_command{
                human_monitor_command{
                    ...
                    cpu_index:cpu_index,command_line:command_line
                }
            }
            ...
            pub fn new()->query_migrate_cache_size{
                query_migrate_cache_size{
                    execute: "query_migrate_cache_size".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<int,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_dump_guest_memory_capability{
                query_dump_guest_memory_capability{
                    execute: "query_dump_guest_memory_capability".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<DumpGuestMemoryCapability,String>{
                            try!(json::decode(&response))
                        }
        ...
        pub struct netdev_add {
            execute: String,
            pub props:String,pub id:String,pub qemu_type:String,gen: bool
        }
        impl netdev_add {
            pub fn new(props:String,id:String,qemu_type:String)->netdev_add{
                netdev_add{
                    execute: "netdev_add".to_string(),
                    props:props,id:id,qemu_type:qemu_type
                }
            }
        ...
        pub struct add_fd {
            execute: String,
            pub fdset_id:String,pub opaque:String
        }
        impl add_fd {
            pub fn new(fdset_id:String,opaque:String)->add_fd{
                add_fd{
                    execute: "add_fd".to_string(),
                    fdset_id:fdset_id,opaque:opaque
                }
            }
            
                        pub fn parse_qemu_response(response: &String) -> QemuResult<AddfdInfo,String>{
                            try!(json::decode(&response))
                        }
            ...
            pub fn new()->query_target{
                query_target{
                    execute: "query_target".to_string(),
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<TargetInfo,String>{
                            try!(json::decode(&response))
                        }
        ...
        pub struct send_key {
            execute: String,
            pub hold_time:String,pub keys:Vec<String>
        }
        impl send_key {
        ...
        pub struct chardev_add {
            execute: String,
            pub backend:String,pub id:String
        }
        impl chardev_add {
            pub fn new(backend:String,id:String)->chardev_add{
                chardev_add{
                    ...
                    backend:backend,id:id
                        ...
                        pub fn parse_qemu_response(response: &String) -> QemuResult<ChardevReturn,String>{
                            try!(json::decode(&response))
                        }
        ...
        pub struct x_input_send_event {
            execute: String,
            pub console:String,pub events:Vec<String>
        }
